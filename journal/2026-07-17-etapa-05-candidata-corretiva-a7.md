...
Nenhum commit, push, CI pública, tag, release ou contato externo foi realizado. A candidata local não fecha o finding da release imutável e não autoriza a 5.9.3.
