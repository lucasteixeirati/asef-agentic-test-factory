...
| 13. Evolução baseada em evidências | ADR-004, ADR-007, ADR-008, ADR-009; checkpoints; revisões 5.3/5.4; Smoke 20/20; quality capabilities; segurança/doctor/retention; reports; correção `v0.1.0a7`; avaliação I01; Lesson 003 | forte até o pacote pré-Gate 5; independência externa pendente |
