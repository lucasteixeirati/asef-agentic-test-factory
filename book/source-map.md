...
| 13. Evolução baseada em evidências | ADR-004, ADR-007, ADR-008, ADR-009; checkpoints; revisões 5.3/5.4; Smoke 20/20; quality capabilities e `v0.1.0a4`; candidata local `0.1.0a5` | forte até o Alpha Python pré-Gate 5 |
