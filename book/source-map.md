...
| 8. Segurança para executar código gerado | EXP-002; Docker tests; sandbox policy; Security 12/12; doctor; retention/cleanup; provas Windows/Linux do 5.7; conformance API networkless da 6.3.2; política fail-closed e threat model de DNS rebinding da 6.3.3 | forte para baseline; adapter externo pinado ainda não implementado |
| 9. Como testar componentes não determinísticos | cassettes; structured output; retries; mutation pilot; adapter live e budget real do 5.4; geração API live contabilizada e OpenAPI delimitador da 6.3.3; coverage/mutation do SUT implementadas no 5.6 | forte para o primeiro provider e para a baseline Python limitada |
