...
| Etapa 5.8 — relatórios e experiência pública | Candidata `0.1.0a6` aprovada na CI | 2026-07-16 | — | 2+ | Seis fatias implementadas e revisadas; walkthrough/regressões e sete jobs públicos verdes; tag e publicação pendentes |
