...
- **Estado:** execução em andamento; `v0.1.0a7` publicada e postflight remoto aprovado; 5.9.3 aguarda autorização humana
...
| G5-18 | README, quickstart, tutorial, arquitetura, segurança e limitações refletem o Alpha real | auditoria documental | Atendido com risco residual da sessão: `v0.1.0a7` publicada, assets remotos reauditados e `PREFLIGHT-F-001` resolvido; compreensão externa ainda não observada |
...
| G5-20 | CI pública e regressões do Gate 4 permanecem verdes | execução GitHub Actions | Atendido: commit corretivo `58ea802` aprovado nos sete jobs da CI `29620941881`, preservando as provas anteriores |
