...
|---|---|---|---|
| G5-01 | Wheel instala e executa fora do checkout | sessão limpa + CI de package audit | Atendido: wheel e sdist `0.1.0a4` auditados, instalação limpa aprovada e pré-release `v0.1.0a4` publicada |
