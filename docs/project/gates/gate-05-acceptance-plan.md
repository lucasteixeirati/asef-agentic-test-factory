...
- **Estado:** execução em andamento; 5.7 publicado em `v0.1.0a5`; candidata 5.8/`0.1.0a6` aprovada na CI pública; publicação e 5.9 pendentes
...
| G5-18 | README, quickstart, tutorial, arquitetura, segurança e limitações refletem o Alpha real | auditoria documental | Atendido no 5.8.6: checker sem findings, walkthrough frio completo e job `public-experience` verde |
