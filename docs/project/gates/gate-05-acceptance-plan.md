...
|---|---|---|---|
| G5-01 | Wheel instala e executa fora do checkout | sessão limpa + CI de package audit | Atendido: wheel e sdist `0.1.0a7` auditados, instalação limpa e postflight remoto aprovados |
...
| G5-17 | Core não importa Python tooling, Docker, OpenAI ou LangGraph | import boundaries + job core mínimo | Atendido até `v0.1.0a7`: fronteiras AST e job core aprovados na matriz pública de sete jobs |
| G5-18 | README, quickstart, tutorial, arquitetura, segurança e limitações refletem o Alpha real | auditoria documental | Atendido com risco residual: `v0.1.0a7` e postflight aprovados; compreensão interna será observada em 5.9.3, mas independência externa foi adiada e não será alegada |
...
| G5-20 | CI pública e regressões do Gate 4 permanecem verdes | execução GitHub Actions | Atendido: implementação `58ea802`, release `79fbeb0` e fechamento postflight `3d74c91` aprovados nas CIs `29620941881`, `29647693611` e `29648119788`, todas com os sete jobs canônicos |
