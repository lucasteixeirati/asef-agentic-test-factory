...
|---|---|---|---|
| G5-01 | Wheel instala e executa fora do checkout | sessão limpa + CI de package audit | Atendido em `v0.1.0a3`; candidata `0.1.0a4` aprovada localmente e na CI `29461154744` |
